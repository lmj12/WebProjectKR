$(document).ready(
	...
	function inputcheck(){
		...
		if( !inputform.jbskId.value){
			...
			alert( "이메일 종류를 선택하세요" );
			return false;
		}else if( (inputform.jbskEmail1.value.indexOf("@") != -1 ) && (document.getElementById("jbskEmail2").value == "1")){
			alert( "알맞은 이메일 형식을 입력하세요");
			return false;
		}else if( (inputform.jbskEmail1.value.indexOf("@") != -1 ) && (document.getElementById("jbskEmail2").value == "2")){
			alert( "알맞은 이메일 형식을 입력하세요");
			return false;
		}else if( (inputform.jbskEmail1.value.indexOf("@") != -1 ) && (document.getElementById("jbskEmail2").value == "3")){
			alert( "알맞은 이메일 형식을 입력하세요");
			return false;
		}else if( (inputform.jbskEmail1.value.indexOf("@") != -1 ) && (document.getElementById("jbskEmail2").value == "4")){
			alert( "알맞은 이메일 형식을 입력하세요");
			return false;
