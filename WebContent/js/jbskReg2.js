...
//					alert(email);
//					if( (email.indexOf("@") != -1 ) && (target.options[target.selectedIndex].text == "naver.com")){
//						alert( "알맞은 이메일 형식을 입력하세요");
//						return false;
//					}else if( (email.indexOf("@") != -1 ) && (target.options[target.selectedIndex].text == "daum.net")){
//						alert( "알맞은 이메일 형식을 입력하세요");
//						return false;
//					}else if( (email.indexOf("@") != -1 ) && (target.options[target.selectedIndex].text == "gmail.com")){
//						alert( "알맞은 이메일 형식을 입력하세요");
//						return false;
//					}else if( (email.indexOf("@") != -1 ) && (target.options[target.selectedIndex].text == "nate.com")){
//						alert( "알맞은 이메일 형식을 입력하세요");
//						return false;
//					}else if( (email.indexOf("@") == -1 ) && (target.options[target.selectedIndex].text == "직접입력")){
//						alert( "알맞은 이메일 형식을 입력하세요");
//						return false;
//					} else {
					$(this).parents('.form-group')
