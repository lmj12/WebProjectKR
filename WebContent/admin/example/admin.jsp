...
<body>
	<nav class="navbar fixed-top navbar-dark bg-primary">
		<button class="navbar-toggler hidden-sm-up float-right" type="button"
	...
	<div class="container-fluid" id="main">
		<div class="row row-offcanvas row-offcanvas-left">
			...
			<div class="col-md-9 col-lg-10 main">
				...
				<h1 class="display-1 hidden-xs-down">Bootstrap 4 Dashboard</h1>
				...
				<div class="row placeholders">
					<div class="col-6 col-sm-3 placeholder text-center">
						<img src="//placehold.it/200/dddddd/fff?text=1"
							class="mx-auto img-fluid circle"
						...
						<div class="card card-default card-body">
							...
							<div id="tabsJustifiedContent" class="tab-content">
								<div class="tab-pane fade" id="tab1">
									<div class="list-group">
										<a href="" class="list-group-item"><span
											class="float-right badge badge-success">51</span> Home Link</a> <a
											href="" class="list-group-item"><span
											class="float-right badge badge-success">8</span> Link 2</a> <a
											href="" class="list-group-item"><span
											class="float-right badge badge-success">23</span> Link 3</a> <a
								...
								<div class="tab-pane fade" id="tab3">
									<div class="list-group">
										<a href="" class="list-group-item"><span
											class="float-right badge badge-info label-pill">44</span> <code>.panel</code>
											is now <code>.card</code></a> <a href="" class="list-group-item"><span
											class="float-right badge badge-info label-pill">8</span> <code>.nav-justified</code>
											is deprecated</a> <a href="" class="list-group-item"><span
											class="float-right badge badge-info label-pill">23</span> <code>.badge</code>
					...
					<div class="col-lg-6">
						<div id="accordion" role="tablist" aria-multiselectable="true">
							<div class="card">
								...
								<div id="collapseTwo" class="card-body collapse" role="tabpanel"
