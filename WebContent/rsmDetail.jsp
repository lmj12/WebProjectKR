...
<div id="resume" style="margin: 7px">
	...
	<table border='1' id="jbsk">
		<tr>
			<th>성 명</th><td colspan="3" width="250">(한 글)&emsp;&emsp;${crrDto.jbskName}</td>
		</tr>
		<tr>
			<th>나이</th><td width="70" id="age" style="text-align: center"></td><th>생년월일</th><td id="bd"></td>
		</tr>
		<tr>
			<th>email</th><td>${crrDto.jbskEmail}</td><th>전화번호</th><td>${crrDto.jbskTel}</td>
		</tr>
		<tr>
			<th>주소</th><td colspan='3' style="text-align: center">${crrDto.jbskAdd1} &nbsp; ${crrDto.jbskAdd2} &nbsp; ${crrDto.jbskAdd3}&nbsp;</td>
		</tr>
	</table>
	<br><br>
	<h4><b>자기소개서</b></h4><br>
	<textarea id="jbskIt" rows="10" cols="65">${crrDto.jbskIt}</textarea>
</div>
<br>
<div id="iptcrr">
	<c:if test="${iptSize != 0}">
