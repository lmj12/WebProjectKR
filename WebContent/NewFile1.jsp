...
insert into KRjobseeker values('human14', '1212abc', sysdate, 'choi', 2, TO_DATE('1992/10/13 12:28:14', 'YYYY/MM/DD HH:MI:SS'), '--', '서울', '동대문구', 'gw@naver.com', '01012345678', 'C:\image\sun.jpg', 1, '자기소개서');
 ...
 insert into KRboard values('0_1', '공지드립니다.신고내용에 신고하시는 업체 꼭 기입해주세요', 1, 0, 'admin1', to_date('10/17/2018 12:41:15', 'MM/dd/yyyy hh24:mi:ss'));
 insert into KRboard values('0_2', '공지 : 10/14일에서 10/15일은 서버점검기간입니다', 1, 0, 'admin2', to_date('10/13/2018 12:41:15', 'MM/dd/yyyy hh24:mi:ss'));
 insert into KRboard values('0_3', '공지:이 게시판은 신고용도로만 사용해주세요', 1, 0, 'admin3', to_date('10/16/2018 12:41:15', 'MM/dd/yyyy hh24:mi:ss'));
 insert into KRboard values('0_4', '신고이외의 목적의 글은 삭제될 수도 있습니다', 1, 0, 'admin1', to_date('10/16/2018 12:41:15', 'MM/dd/yyyy hh24:mi:ss'));
 insert into KRboard values('0_5', '신고이외의 궁금한 사항은 업체에 연락해주세요', 1, 0, 'admin2', to_date('10/17/2018 12:55:15', 'MM/dd/yyyy hh24:mi:ss'));