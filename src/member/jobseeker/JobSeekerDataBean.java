...
public class JobSeekerDataBean {
	private String jbskId;
	private String jbskPasswd;
	...
	public String getJbskPasswd() {
		return jbskPasswd;
	}
	public void setJbskPasswd(String jbskPasswd) {
		this.jbskPasswd = jbskPasswd;
	}
